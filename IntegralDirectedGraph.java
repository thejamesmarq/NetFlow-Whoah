/*****************************************************************************
 * File: IntegralDirectedGraph.java
 * Author: Keith Schwarz (htiek@cs.stanford.edu)
 *
 * A class representing a directed graph where each edge has an associated 
 * integral-valued length.  Internally, the class is represented by an 
 * adjacency list.
 */
import java.util.*; // For HashMap

public final class IntegralDirectedGraph<T> implements Iterable<T> {
